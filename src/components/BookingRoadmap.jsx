  ...
  const steps = [
    {
      ...
      description: "Mixture Of Metal And Other Elents Hey Generay Provide Dreter.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-8 h-8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-3.75-12H5.25A2.25 2.25 0 0 0 3 8.25v8.25A2.25 2.25 0 0 0 5.25 18.75h13.5a2.25 2.25 0 0 0 2.25-2.25V11.25M15 11.25h.008v.008H15v-.008Zm0 3h.008v.008H15v-.008Zm0 3h.008v.008H15v-.008Z" />
        </svg>
      ),
    },
    {
  ...
  return (
    <section className="relative w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-zinc-950 transition-colors duration-300 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-6 md:gap-x-8 w-full">
          {steps.map((step) => (
            <Card 
              key={step.id} 
              className="flex flex-col items-center justify-between text-center p-5 bg-white dark:bg-zinc-900/40 border border-slate-200/60 dark:border-zinc-800/60 shadow-sm rounded-3xl group transition-all duration-300 hover:shadow-md hover:border-emerald-500/30 dark:hover:border-emerald-400/20"
            >
              <div className="flex flex-col items-center w-full">
                <div className="relative flex items-center justify-center w-24 h-24 md:w-28 md:h-28 rounded-full bg-emerald-600 dark:bg-emerald-500 text-white shadow-lg shadow-emerald-500/10 mb-6 border-[3px] border-dashed border-sky-200/50 dark:border-sky-800/40 transition-transform duration-300 group-hover:scale-105">
